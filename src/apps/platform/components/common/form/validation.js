...
export const validations = {
  ...
  isExist: (values, value) => {
    return isExist(value);
  },
  matchRegexp: (values, value, regexp) => {
    return !isExist(value) || isEmpty(value) || regexp.test(value);
  },
  ...
  isLength: (values, value, length) => {
    return !isExist(value) || isEmpty(value) || value.length === length;
  },
  equals: (values, value, eql) => {
    return !isExist(value) || isEmpty(value) || value == eql; // eslint-disable-line eqeqeq
  },
  equalsField: (values, value, field) => {
    return value == values[field]; // eslint-disable-line eqeqeq
  },
  maxLength: (values, value, length) => {
    return !isExist(value) || value.length <= length;
  },
